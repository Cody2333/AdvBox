...
"""
CNN on cifar data using pytorch
"""
...
train_data = torchvision.datasets.CIFAR10(
 './cifar-pytorch/data', train=True, transform=torchvision.transforms.ToTensor(), download=True
)
test_data = torchvision.datasets.CIFAR10(
 './cifar-pytorch/data', train=False, transform=torchvision.transforms.ToTensor()
)
